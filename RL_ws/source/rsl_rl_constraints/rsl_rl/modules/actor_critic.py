        ...
        **kwargs,
        ...
        for l in range(len(critic_hidden_dims)):
            if l == len(critic_hidden_dims) - 1:
                ...
                critic_layers.append(activation)
        self.reward_critic = nn.Sequential(*critic_layers)


    def evaluate(self, critic_observations, **kwargs):
        value = self.reward_critic(critic_observations)
        return value
        ...
        **kwargs,
        ...
        for l in range(len(critic_hidden_dims)):
            if l == len(critic_hidden_dims) - 1:
                ...
                critic_layers.append(activation)
        self.cost_critic = nn.Sequential(*critic_layers)

  

    def evaluate(self, critic_observations, **kwargs):
        value = self.cost_critic(critic_observations)
        return value
