...
# Pre-defined configs
##
from isaaclab_assets.robots.rbq10 import RBQ10_CFG, RBQ10_TWO_STAND_CFG  # isort: skip
...
class RBQEnvCfg(DirectRLEnvCfg):
    ...
    undesired_contact_body_ids_list = ["base",".*hip",".*thigh",".*calf"] #["base",".*hip"]
    ...
    feet_nominal_pos_reward_scale = -0.0
    feet_slip_reward_scale = -0.0
    symetry_reward_scale = -0.0 #-2.5

    lin_vel_reward_scale = 1.0
    yaw_rate_reward_scale = 0.5
    orientation_reward_scale = -4.0
    
    contact_pattern_reward_scale= 0.0
    base_height_reward_scale = -4.0
    foot_height_reward_scale = 0.0
    gait_frequency_reward_scale = 0.0

    feet_stumble_force_reward_scale = -0.0# -2.5
    
    termination_reward_scale = -5.0#-500.0  
    ...
    # robot
    robot: ArticulationCfg = RBQ10_TWO_STAND_CFG.replace(prim_path="/World/envs/env_.*/Robot")
