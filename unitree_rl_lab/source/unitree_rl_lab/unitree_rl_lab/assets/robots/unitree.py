...
UNITREE_B2_CFG = UnitreeArticulationCfg(
    ...
    spawn=UnitreeUsdFileCfg(
        usd_path="/home/js/Desktop/unitree_ros/robots/b2_description/urdf/b2_description/configuration/b2_description_physics.usd",
        articulation_props=sim_utils.ArticulationRootPropertiesCfg(
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            ".*R_hip_joint": -0.0,
            ".*L_hip_joint": 0.0,
            "F[L,R]_thigh_joint": 0.773180859,
            "R[L,R]_thigh_joint": 0.773180859,
            ".*_calf_joint": -1.5,
        },
        joint_vel={".*": 0.0},
    ),
