...
from unitree_rl_lab.assets.robots.unitree import UNITREE_B2_CFG as ROBOT_CFG
...
class RobotSceneCfg(InteractiveSceneCfg):
    ...
    terrain = TerrainImporterCfg(
        ...
        terrain_type="plane",  # flat ground for fast training
...
class RewardsCfg:
    ...
    track_lin_vel_xy = RewTerm(
        func=mdp.track_lin_vel_xy_yaw_frame_exp, weight=5.0, params={"command_name": "base_velocity", "std": math.sqrt(0.25)}
    )
    ...
    # -- base
    base_height = RewTerm(func=mdp.base_height_l2, weight=-3.0,    params={"target_height": 0.5},)
    ...
    joint_vel = RewTerm(func=mdp.joint_vel_l2, weight=-1e-7)
    ...
    foot_clearance = RewTerm(
        func=mdp.foot_clearance_reward, weight=-2.0, params={
            "asset_cfg": SceneEntityCfg("robot", body_names=".*_foot"), "target_height": 0.10, "std": 0.05, "tanh_mult": 2.0},)
    # joint_mirror = RewTerm(
    #     func=mdp.joint_mirror, weight=-0.5,
    #     params={"asset_cfg": SceneEntityCfg("robot"),
    #         "mirror_joints": [["FL_(hip|thigh|calf)_joint", "FR_.*"], ["RL_.*", "RR_.*"]]},
    #     )
    ...
    #     params={
    #         "threshold": 1,
    #         "sensor_cfg": SceneEntityCfg("contact_forces", body_names=["head_Link", ".*_hip", ".*_thigh", ".*_calf"]),
    #     },
    # )
